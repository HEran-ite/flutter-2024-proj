...
class StatusPage extends ConsumerWidget {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildCard(context, ref, booking, index);
              },
            ),
          ),
        ],
  ...
  Widget _buildCard(
      BuildContext context, WidgetRef ref, Booking booking, int index) {
    return Card(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    _showDatePickerDialog(context, ref, index);
                  },
                  child: const Text(
                    'Edit',
                ...
                ElevatedButton(
                  onPressed: () {
                    ref.read(bookingProvider.notifier).deleteBooking(index);
                  },
                  child: const Text(
                    'Delete',
  ...
  void _showDatePickerDialog(
    ...
    if (selectedDate != null) {
      ref.read(bookingProvider.notifier).updateBookingDate(index, selectedDate);
    }
  }
}
